...
import aubg.hack.ailyak.data.model.Constants
import aubg.hack.ailyak.https.AnimalApiService
...
object NetworkModule {
    ...
    @Provides @Singleton
    fun provideWaterApiService(@Named("overpass") retrofit: Retrofit): WaterApiService =
    ...
    ): CellTowerApiService = retrofit.create(CellTowerApiService::class.java)
}