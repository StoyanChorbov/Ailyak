...
import aubg.hack.ailyak.service.PlantApiService
import kotlin.math.*
...
class PlantRepository @Inject constructor(
    ...
    private fun PlantEntity.toPlantUiItem() = PlantUiItem(
        id               = id,
    ...
    private fun PlantUiItem.toEntity(lat: Double, lng: Double) = PlantEntity(
        id               = id,
        scientificName   = scientificName,
        commonName       = commonName,
        photoUrl         = photoUrl,
